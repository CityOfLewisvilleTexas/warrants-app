...
var app = new Vue({
    ...
    computed: {
        tabs: function() {
            var tabs = [
                { name: 'Views', key: 'views', icon: 'view_compact' },
                { name: 'Folders', key: 'folders', icon: 'folder' },
    ...
    // functions
    methods: { test: function(a) { window.open('http://apps.cityoflewisville.com/warrants/#!/defendant/' + a) },
